<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Start.aspx.cs" Inherits="Online_Music_System.Start" %>
         ...
         <div class="title">
          ...
          &nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
             The Music Chamber
              <asp:ImageButton ID="ImageButton1" CssClass="homebtn" runat="server" ImageUrl="~/homeicon.png" Height="35px" Width="30px" OnClick="ImageButton1_Click" />
        </div>
...
<asp:Image ID="Image1" runat="server" ImageUrl=' <%#"Handler1.ashx?uname=" + Eval("Img_Id")%>' Height="154px" Width="150px" />
      ...
      <br/>  <asp:Label ID="Label2"  Width="100%" runat="server" CssClass="playlst" Text=" "></asp:Label>
